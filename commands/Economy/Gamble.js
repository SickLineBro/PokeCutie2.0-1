...
module.exports = {
  ...
  execute: async (client, message, args, prefix, guild, color, channel) => {
    ...
    if (!user2 || !user2.pokemons[0]) return message.channel.send(user1.user.username + " needs to pick a starter Pokemon using the \`" + prefix + "start\` command before gambling!");
