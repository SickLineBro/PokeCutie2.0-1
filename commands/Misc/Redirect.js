...
module.exports = {
    ...
    if(!nchannel) return message.channel.send(`Correct usage: **${nguild.prefix || client.config.prefix}redirect <mentionchannel/id/name>**`);
      ...
      await nguild.save();
      return message.channel.send( {embed: {title: `Redirect channel configuration`, color:'#ff0000', description: `Redirect channel for ${message.guild.name} has been set to <#${nguild.spawnchannel}> `}} );
  }
}  